...
if (isset($sr_LGA_bt)){
	...
	$lgSearch=mysql_query("select * from $sr_LGA where fname like '$sr_fname%' and lname like '$sr_lname%' and phone like '$sr_phone%' order by sn",$conn);
	if(!$lgSearch)
		{
	...
	} else {$notify_msg="Wrong LGA picked!";}
...
<div class="update_wrapper">
	<p>
	<h2  style="margin-left:50px; float: inherit">Home &gt;&gt; Update <label style="font-size:12px; color:#900; margin-left:350px;"> *Update and delete functions are performed here!</label></h2>
	</p>
...
<br />
<br />
<p id="copy_wrap">Assembled and Formed by TP-Soft; <em>TransformationPrime</em> &copy; <a href="http://www.trans-prime.com" target="_blank">Trans-Prime.com</a><span style="background-color:#FFF; word-spacing:10px; width:92%">
